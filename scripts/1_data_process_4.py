...
# 儲存路徑
DATA_PATH = "data/vulnerability_data_4.json"
CHUNKS_PATH = "data/vulnerability_chunks_4.json"
VECTOR_DB_PATH = "data/vulnerability_knowledge_base_4"
...
urls = {
    "Spectre (Side Channel Attack)": {
        "CVE": "https://nvd.nist.gov/vuln/detail/CVE-2017-5753",
        "Microsoft": "https://msrc.microsoft.com/update-guide/vulnerability/CVE-2017-5753",
        "Mitre": "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-5753",
        "CISA": "https://www.cisa.gov/news-events/alerts/2018/01/04/meltdown-and-spectre-side-channel-vulnerability-guidance"
    },
    "Meltdown (Kernel Memory Disclosure)": {
        "CVE": "https://nvd.nist.gov/vuln/detail/CVE-2017-5754",
        "Microsoft": "https://msrc.microsoft.com/update-guide/vulnerability/CVE-2017-5754",
        "Mitre": "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-5754",
        "CISA": "https://www.cisa.gov/news-events/alerts/2018/01/04/meltdown-and-spectre-side-channel-vulnerability-guidance"
    },
    "Kerberos Ticketing Spoofing": {
        "CVE": "https://nvd.nist.gov/vuln/detail/CVE-2023-35365",
        "Microsoft": "https://msrc.microsoft.com/update-guide/vulnerability/CVE-2023-35365",
        "Mitre": "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2023-35365"
    }
}
